...
public class HttpSourceRegistrar extends AbstractFunctionsRegistrar {
	...
	public void afterPropertiesSet() {
		if (this.pubSubBridgeProperties.getRunningMode() == PubSubBridgeProperties.RunningMode.PUBLISHER) {
			Map<String, Object> springCloudStreamProperties = new HashMap<>();

			String publisherDestination = this.pubSubBridgeProperties.getPublisher().getDestination();
