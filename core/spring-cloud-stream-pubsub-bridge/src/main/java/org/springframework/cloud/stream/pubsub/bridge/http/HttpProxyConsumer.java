...
public class HttpProxyConsumer implements Consumer<byte[]> {
	...
	public HttpProxyConsumer(PubSubBridgeProperties pubSubBridgeProperties,
	...
	public void accept(byte[] bytes) {
		...
		PubSubBridgeProperties.Subscriber subscriber = pubSubBridgeProperties.getSubscriber();
		...
		if (body != null) {
			...
			if (pubSubBridgeProperties.getRunningMode() == PubSubBridgeProperties.RunningMode.SUBSCRIBER_PUBLISHER &&
