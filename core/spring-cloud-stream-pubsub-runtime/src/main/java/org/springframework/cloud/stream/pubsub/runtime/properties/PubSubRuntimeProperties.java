...
package org.springframework.cloud.stream.pubsub.runtime.properties;

import org.springframework.boot.context.properties.ConfigurationProperties;

/**
 * Configuration properties for the PubSub runtime platform.
 *
 * @author Soby Chacko
 */
...
public class PubSubRuntimeProperties {
	...
	/**
	 * The transport protocol used for application communication to the runtime.
	 * Default is HTTP.
	 */
	private TransportMode transportMode = TransportMode.HTTP;

	/**
	 * Running mode of the runtime (publisher, subscriber, both subscriber and publisher).
	 */
	...
	public enum TransportMode {
		...
		/**
		 * In this mode, the runtime provides HTTP based runtime.
		 */
		HTTP,
